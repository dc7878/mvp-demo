 ...
 */
public class IOSFragment extends BaseFragment implements IAndroidView,AdapterView.OnItemClickListener{
    ...
    protected void onFirstVisible() {
        ...
        androidPresenter.loadData(true, ApiUtil.EventType.EVENT_REFRESH, ApiUtil.GankApi.GANK_IOS,
                pageNumber, SIZE);
    }
