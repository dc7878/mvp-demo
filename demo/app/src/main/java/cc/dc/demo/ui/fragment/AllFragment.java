 ...
 */
public class AllFragment extends BaseFragment implements IAndroidView,AdapterView.OnItemClickListener{
    ...
    protected void onFirstVisible() {
        ...
        androidPresenter.loadData(true, ApiUtil.EventType.EVENT_REFRESH, ApiUtil.GankApi.GANK_ALL,
                pageNumber, SIZE);
    }
